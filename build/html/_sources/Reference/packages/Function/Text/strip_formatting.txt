...
.. php:function:: strip_formatting(string $str, string $allowableTags = , string $fallbackStr = )
    ...
    This is essentially a wrapper around PHP's strip_tags() function, with theadded benefit of returning a fallback
    string in case the resulting strippedstring is empty or contains only whitespace.
