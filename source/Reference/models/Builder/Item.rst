...
.. php:class:: Builder_Item
    ...
    .. php:method:: addFiles(string|Omeka_File_Ingest_AbstractIngest $transferStrategy, string|array $files, array $options = Array)
