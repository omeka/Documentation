...
.. php:class:: Omeka_Db_Table
    ...
    .. php:method:: setTablePrefix(string|null $tablePrefix)
        ...
        require customization, e.g. creating wrappers for tables generated by
        other applications.
    ...
    .. php:method:: _getColumnPairs()
        ...
        is the same in every instance.  This is an attempt to stay DRY.
    ...
    .. php:method:: findBy(array $params = Array, integer $limit, integer $page)
        ...
        :param array $params: A set of parameters by which to filter the objects that get returned from the DB.
