...
.. php:class:: Omeka_Db_Table
    ...
    .. php:method:: __call(string $m, array $a)
        ...
        Used primarily as a convenience method. For example, you can call fetchOne() and fetchAll() directly from this
        object.
    ...
    .. php:method:: setTableName(string $name)
        ...
        If no name is provided, it will inflect the table name from the name of the model defined in the constructor. For
        example, Item -> items.
    ...
    .. php:method:: setTablePrefix(string|null $tablePrefix)
        ...
        Defaults to the table prefix defined by the Omeka_Db instance. This should remain the default in most cases.
        However, edge cases may require customization, e.g. creating wrappers for tables generated by other applications.
    ...
    .. php:method:: _getColumnPairs()
        ...
        This is a template method because these columns are different for every table, but the underlying logic that
        retrieves the pairs from the database is the same in every instance.
