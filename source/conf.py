...
project = u'Omeka Classic'

copyright = u'2012-2023, Omeka'
...
# of the sidebar.
html_logo = '_static/images/logo-horizontal-200px.png'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
#html_favicon = '_static/images/omeka-favicon.ico'
...
latex_documents = [ 
  ('index', 'Omeka.tex', u'Omeka Classic Developer Documentation',
   u'Omeka Team', 'manual'),
]
...
man_pages = [
    ('index', 'omeka', u'Omeka Classic Developer Documentation',
     [u'Omeka Team'], 1)
]
...
texinfo_documents = [
  ('index', 'Omeka', u'Omeka Classic Developer Documentation',
   u'Omeka', 'Omeka', 'One line description of project.',
   'Miscellaneous'),
]
